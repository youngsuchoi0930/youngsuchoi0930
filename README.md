...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=800&color=4F8CC9&center=true&vCenter=true&width=700&lines=EST+Soft+Camp+AI+%EA%B5%90%EC%9C%A1%EC%83%9D;Python+%7C+Pandas+%7C+NumPy+%7C+Machine+Learning;Data%EB%A1%9C+%EC%84%B8%EC%83%81%EC%9D%84+%EC%9D%BD%EB%8A%94+AI+%EA%B0%9C%EB%B0%9C%EC%9E%90%EB%A5%BC+%EA%BF%88%EA%BE%B8%EB%A9%B0!" alt="Typing SVG" />
</p>
...
- 🎓 **EST Soft Camp** 에서 AI / 데이터 사이언스를 공부하고 있어요
- 🐍 Python 으로 데이터를 다루고 모델을 만드는 것을 좋아합니다
- 📊 데이터 속에서 인사이트를 발견하는 과정에 매료되어 있어요
- 🤖 머신러닝 · 딥러닝 프로젝트를 직접 만들어 보며 성장 중입니다
- 📚 매일 새로운 라이브러리와 알고리즘을 배워가고 있어요
...
class YoungsuChoi:
    def __init__(self):
        ...
        self.education   = "EST Soft Camp"
        self.languages   = ["Python", "SQL"]
        self.now_studying = [
            "Pandas / NumPy 로 데이터 전처리",
            "Scikit-learn 으로 머신러닝 모델링",
            "TensorFlow · PyTorch 로 딥러닝",
            "Kaggle 대회 도전",
        ]
...
<p align="center">
  <a href="mailto:youngsuchoi0930@example.com">
